...
class ajaxRegistro
{
    ...
    public function registrarEntrada($datos, $orden, $fecha, $fecha_entrada, $motivo, $conductor, $responsable, $despachado, $autorizado)
    {

        $data = ModeloRegistro::mdlRegistrarEntrada($datos, $orden, $fecha, $fecha_entrada, $motivo, $conductor, $responsable, $despachado, $autorizado);
        echo json_encode($data, JSON_UNESCAPED_UNICODE);
    }
    ...
    public function registrarRetorno($datos, $boleta, $fecha_retorno, $nro_guia, $autorizado)
    {

        $data = ModeloRegistro::mdlRegistrarRetorno($datos, $boleta, $fecha_retorno, $nro_guia, $autorizado);
        echo json_encode($data, JSON_UNESCAPED_UNICODE);
    }
    ...
    public function registrarFabricacion($datos, $orden, $nro_guia, $conductor, $despachado, $responsable, $fecha, $motivo, $tras, $img, $autorizado)
    {
        $data = ModeloRegistro::mdlRegistrarFabricacion($datos, $orden, $nro_guia, $conductor, $despachado, $responsable, $fecha, $motivo, $tras, $img, $autorizado);
        echo json_encode($data, JSON_UNESCAPED_UNICODE);
    }
    ...
    public function actualizarDatosFabricacion($datos, $id_boleta, $orden, $nro_guia, $conductor, $despachado, $responsable, $fecha, $fecha_retorno, $motivo,  $tras, $img, $autorizado)
    {
        $data = ModeloRegistro::mdlActualizarDatosFabricacion($datos, $id_boleta, $orden, $nro_guia, $conductor, $despachado, $responsable, $fecha, $fecha_retorno, $motivo,  $tras, $img, $autorizado);
        echo json_encode($data, JSON_UNESCAPED_UNICODE);
    }
}
...
if (isset($_POST["accion"])) {
    ...
    if ($accion == 1) {
        ...
        $registro->registrarEntrada($_POST["arr"], $_POST["orden"], $_POST["fecha"], $_POST["fecha_retorno"], $_POST["motivo"], $_POST["conductor"], $_POST["responsable"], $_POST["despachado"], $_POST["autorizado"]);
    } else if ($accion == 9) {
        ...
        $registro->registrarFabricacion($_POST["datos"], $_POST["orden"], $_POST["nro_guia"], $_POST["conductor"], $_POST["despachado"], $_POST["responsable"], $_POST["fecha"],  $_POST["motivo"], $_POST['tras'],$imagenes, $_POST["autorizado"]);
    }else if ($accion == 12) {
        $imagenes = isset($_FILES["imagenes"]) ? $_FILES["imagenes"] : [];
        $registro->actualizarDatosFabricacion($_POST["datos"], $_POST["id_boleta"], $_POST["orden"], $_POST["nro_guia"], $_POST["conductor"], $_POST["despachado"], $_POST["responsable"], $_POST["fecha"], $_POST["fecha_retorno"], $_POST["motivo"], $_POST['tras'], $imagenes, $_POST["autorizado"]);
    //else if ($accion == 13) {
