...
class ajaxRegistro
{
    ...
    public function registrarFabricacion($datos, $orden, $nro_guia, $conductor, $despachado, $responsable, $fecha, $motivo, $tras, $img)
    {
        $data = ModeloRegistro::mdlRegistrarFabricacion($datos, $orden, $nro_guia, $conductor, $despachado, $responsable, $fecha, $motivo, $tras, $img);
        echo json_encode($data, JSON_UNESCAPED_UNICODE);
    }
