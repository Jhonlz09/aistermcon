    ...
    static public function mdlListarPresupuesto($anio, $estado)
    {
        try {
            $consulta = "SELECT p.id, p.num_orden,c.nombre AS cliente,p.descripcion,  
                        ...
                        p.nota, p.id_cliente, null AS acciones, TO_CHAR(o.fecha, 'DD/MM/YYYY') as fecha_ord, TO_CHAR(o.fecha_ope, 'DD/MM/YYYY') as fecha_ope, TO_CHAR(o.fecha_fin, 'DD/MM/YYYY') as fecha_fin, TO_CHAR(o.fecha_fac, 'DD/MM/YYYY') as fecha_fac, o.nota as nota_ord, TO_CHAR(p.fecha, 'YYYY-MM-DD')  as fecha_pre
                ...
                try {
                    ...
                    if ($row && isset($row['id'])) {
                        ...
                        $ins = $conexion->prepare(
                            "INSERT INTO tblclientes(nombre, id_tipo, estado, correo)
                 VALUES(:cliente_manual, 1, false, :correo)
