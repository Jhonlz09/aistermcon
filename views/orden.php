                ...
                render: function(data, type, row, full, meta) {
                    ...
                    return (
                        ...
                        (eliminar ?
                            ...
                            "</button>" : "") +
                        (ruta !== null ?
                            " <a href='/utils/download.php?file=" + encodeURIComponent(ruta) + "&route=ordenes" + "' target='_blank' style='font-size:1.4rem;padding:3px 6.8px' class='btn btnDescargar' title='PDF'>" +
