    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-gradient-green">
                <h4 class="modal-title"><i class="fa-solid fa-user-plus"></i><span> Nuevo Pre trabajo</span></h4>
                            ...
                            <div class="row">
                                <!-- <div class="col-md-12">
                                    <div class="input-data" style="margin-bottom:1rem;">
                                        <input autocomplete="off" id="detalles" class="input-nuevo" type="text" required>
                                        <div class="line underline"></div>
                                        <label for="detalles" class="label"><i class="fas fa-note"></i> Detalle</label>
                                        <div class="invalid-feedback">*Campo obligatorio.</div>
                                    </div>
                                </div> -->
    ...
    $(document).ready(function() {
        ...
        if (btnNuevo) {
            btnNuevo.addEventListener('click', () => {
                accion = 1;
                cambiarModal(span, ' Nuevo Pre trabajo', icon, 'fa-hand-holding-box', elements, 'bg-gradient-blue', 'bg-gradient-green', modal, 'modal-new', 'modal-change')
                form.reset();
        ...
        form.addEventListener("submit", function(e) {
            ...
            const nom = nombre.value.trim().toUpperCase(),
                ...
                dir = detalles.value.trim().toUpperCase(),
