                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-auto col-p" style="padding-right: .3rem">
                                    <h3 class="card-title">Listado de Solicitudes de Despacho</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group mb-0">
                                                ...
                                                <input id="fecha_sol" type="date" autocomplete="off" value="" style="font-size:1.2rem;border-bottom: 2px solid var(--select-border-bottom);" class="form-control form-control-sm" required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label combo" for="cboBoleta">
                                                <i class="fas fa-receipt"></i> Boleta</label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function inicializarSelects() {
            let opcionesEmpleados = [{
                id: '',
                text: 'SELECCIONE'
            }];
            datos_empleados.forEach(emp => {
                opcionesEmpleados.push({
                    id: emp.id,
                    text: emp.nombre
                });
            });

            $(document.getElementById('cboResponsable')).select2({
                data: opcionesEmpleados,
                width: '100%'
            });

            $(document.getElementById('cboAutorizadoPor')).select2({
                data: opcionesEmpleados,
                width: '100%'
            });

            $(document.getElementById('cboDespachoPor')).select2({
                data: opcionesEmpleados,
                width: '100%'
            });
        }
