...
h.defaults={cascadePanes:!1,clear:!0,collapse:!0,columns:[],container:function(a){return a.table().container()},filterChanged:void 0,i18n:{clearMessage:"Limpiar",clearPane:"&times;",collapse:{0:"SearchPanes",_:"SearchPanes (%d)"},collapseMessage:"Collapsar",count:"{total}",countFiltered:"{shown} ({total})",emptyMessage:"<em></em>",emptyPanes:"",loadMessage:"",showMessage:"Mostrar",title:"Filtros activos - %d"},layout:"auto",order:[],panes:[],viewTotal:!1};
